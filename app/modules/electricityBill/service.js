...
//SERVICE PENDING
export const getElecticityBill = async (user, { phonenumber }) => {
  try {
...
export const payElectricityBill = async (user, { telco, phonenumber, amount }) => {
  try {
    ...
    const ussdstring = `${
      USSD_STRINGS[telco.toUpperCase()].PAY_ELECTRICITYBILL
    }${phonenumber}*${amount}#`;
